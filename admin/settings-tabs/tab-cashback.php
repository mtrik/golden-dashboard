...
<form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <h2><?php esc_html_e('کش‌بک شارژ کیف پول', 'golden-dashboard'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row"><?php esc_html_e('فعال‌سازی', 'golden-dashboard'); ?></th>
            <td>
                <label>
                    <input type="checkbox" name="cashback_topup_enabled" value="1" <?php checked($topup_enabled, '1'); ?>>
                    <?php esc_html_e('بعد از هر شارژ موفق کیف پول، درصدی به‌عنوان هدیه به کیف پول کاربر برگردانده شود', 'golden-dashboard'); ?>
                </label>
            </td>
        </tr>
        <tr>
            <th scope="row"><?php esc_html_e('درصد کش‌بک', 'golden-dashboard'); ?></th>
            <td><input type="number" name="cashback_topup_percent" value="<?php echo esc_attr($topup_percent); ?>" min="0" max="100" step="0.1"> %</td>
        </tr>
    </table>

    <h2><?php esc_html_e('کش‌بک خرید طلا', 'golden-dashboard'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row"><?php esc_html_e('فعال‌سازی', 'golden-dashboard'); ?></th>
            <td>
                <label>
                    ...
                    <?php esc_html_e('بعد از هر خرید موفق طلا/فلز، درصدی از مبلغ ریالی به کیف پول کاربر برگردانده شود', 'golden-dashboard'); ?>
                </label>
            </td>
        </tr>
        <tr>
    ...
    <h2><?php esc_html_e('کش‌بک خرید عادی ووکامرس', 'golden-dashboard'); ?></h2>
    <table class="form-table">
        <tr>
            <th scope="row"><?php esc_html_e('فعال‌سازی', 'golden-dashboard'); ?></th>
            <td>
                <label>
                    ...
                    <?php esc_html_e('بعد از هر خرید موفق (هر سفارش عادی تکمیل‌شده در فروشگاه)، درصدی از مبلغ سفارش به کیف پول کاربر برگردانده شود', 'golden-dashboard'); ?>
                </label>
                <p class="description"><?php esc_html_e('سفارش‌های داخلی افزونه (شارژ کیف پول، خرید طلا) از این بخش مستثنی هستند، چون هرکدام کش‌بک اختصاصی خودشان را دارند.', 'golden-dashboard'); ?></p>
            </td>
        </tr>
        <tr>
            <th scope="row"><?php esc_html_e('درصد کش‌بک', 'golden-dashboard'); ?></th>
